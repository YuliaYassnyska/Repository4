...
public void resetValues(String NameOfTheManufacturer, double memoryCapacity, int multiplicity_of_zoom, int color, int price, int ID, int battery_capacity, int warranty_period){
	this.NameOfTheManufacturer = NameOfTheManufacturer;
	this.memoryCapacity = memoryCapacity;
	this.multiplicity_of_zoom = multiplicity_of_zoom;
	this.color = color;
